...
En este sistema, una **Fase** es un bloque lógico de trabajo que representa un hito del proyecto (ej: cada uno de los 9 arneses definidos en `@700_harnesses`). Ninguna fase puede considerarse terminada hasta que supere su gate de aprobación correspondiente.
